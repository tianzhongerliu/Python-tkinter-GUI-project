...
class VideoPlayer(ttk.Frame):
    ...
    def _build_widget(self, parent: ttk.Frame=None, setup: dict=dict):
        ...
        icons_path = os.path.abspath(os.path.join(os.pardir, 'E:\python_project\Python tkinter GUI project\Icons'))
        if setup['play']:
...
def videoplayer_run(window):
    root = Toplevel(window)
    root.geometry('700x600')
    vid = VideoPlayer(root, image=True, play=True, camera=True, algo=True)
